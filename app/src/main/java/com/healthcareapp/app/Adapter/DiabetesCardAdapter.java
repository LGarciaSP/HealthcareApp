...
public class DiabetesCardAdapter extends RecyclerView.Adapter<DiabetesCardAdapter.ViewHolder> {

    private Context mContext;
    private List <Card> mCards;

    public DiabetesCardAdapter(Context mContext, List <Card> mCards){
        this.mCards = mCards;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.diabetes_cards_layout, parent, false);

        return new DiabetesCardAdapter.ViewHolder(view);
    }
