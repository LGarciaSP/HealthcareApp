...
public class DietDiabetesFragment extends Fragment {
    ...
    private void readCards() {
        ...
        String url = "https://health.gov/myhealthfinder/api/v3/topicsearch.json?lang=en&categoryId=diet&keyword=diabetes%20";
