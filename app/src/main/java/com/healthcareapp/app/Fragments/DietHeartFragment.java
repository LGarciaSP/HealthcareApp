...
public class DietHeartFragment extends Fragment {
    ...
    private void readCards() {
        ...
        String url = "https://health.gov/myhealthfinder/api/v3/topicsearch.json?lang=en&categoryId=diseases%2Cdiet&keyword=heart%20\n";
