...
public class ExerciseDiabetesFragment extends Fragment {
    ...
    private void readCards() {
        ...
        String url = "https://health.gov/myhealthfinder/api/v3/topicsearch.json?lang=en&categoryId=exercise&keyword=Diabetes";
